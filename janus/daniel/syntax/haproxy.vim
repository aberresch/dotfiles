...
syn keyword hapParam     acl         skipwhite
syn keyword hapParam     stick-table skipwhite nextgroup=hapStickTable
syn keyword hapParam     timeout     skipwhite nextgroup=hapTimeout

" Options and additional parameters
syn keyword hapStickTable contained type ip size expire store http_req_rate
syn keyword hapTimeout   contained queue connect client server http-keep-alive check http-request
...
syn keyword hapOption    contained httpchk httpclose httplog keepalive logasap persist srvtcpka ssl-hello-chk http-keep-alive
...
syn keyword hapStats     contained uri realm auth scope enable show-node show-desc refresh
